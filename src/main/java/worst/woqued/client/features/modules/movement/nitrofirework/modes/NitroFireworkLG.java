package worst.woqued.client.features.modules.movement.nitrofirework.modes;

import net.minecraft.util.math.Box;
import net.minecraft.util.math.Vec3d;
import worst.woqued.api.module.setting.*;
...
import worst.woqued.client.features.modules.movement.nitrofirework.NitroFireworkMode;
