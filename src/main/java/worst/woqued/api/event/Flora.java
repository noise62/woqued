package worst.woqued.api.event;

import worst.woqued.api.event.interfaces.Cacheable;
import worst.woqued.api.event.interfaces.Notifiable;
import worst.woqued.api.event.interfaces.Subscribable;
