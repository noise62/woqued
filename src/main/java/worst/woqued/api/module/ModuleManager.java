package worst.woqued.api.module;

import lombok.Getter;
import worst.woqued.client.features.modules.combat.*;
import worst.woqued.client.features.modules.combat.*;
import worst.woqued.client.features.modules.combat.elytratarget.ElytraTargetModule;
import worst.woqued.client.features.modules.movement.*;
import worst.woqued.client.features.modules.movement.*;
import worst.woqued.client.features.modules.movement.fly.FlightModule;
import worst.woqued.client.features.modules.movement.nitrofirework.NitroFireworkModule;
...
import worst.woqued.client.features.modules.movement.spider.SpiderModule;
import worst.woqued.client.features.modules.other.*;
...
import worst.woqued.client.features.modules.render.nametags.NameTagsModule;
import worst.woqued.client.features.modules.render.particles.ParticlesModule;
...
public class ModuleManager {
    ...
    public void load() {
        register(
                ...
                SuperKnockbackModule.getInstance(),
